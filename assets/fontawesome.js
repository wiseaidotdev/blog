...
!(function (t) {
  ...
  function U(t, e) {
    "pending" === t._state && ((t._state = "settled"), (t._data = e), k(L, t));
  }
  function I(t, e) {
    "pending" === t._state && ((t._state = "settled"), (t._data = e), k(N, t));
  }
  function T(t) {
  ...
  ((K.prototype = {
    ...
    then: function (t, e) {
      ...
      return (
        (!e && !t) ||
          this._handled ||
          ((this._handled = !0), "rejected" === this._state && P && k(M, this)),
  ...
  function H(t, n) {
    ...
    if (
      ...
      l.push({ id: "fa-kit-upload", url: u });
    }
    var f = l.map(function (o) {
      return new R(function (r, a) {
        var i = o.url || j(t, { addOn: o.addOn, minify: t.minify.enabled }),
          l = { id: o.id },
          s = t.subset
            ? l
            : e(
        ...
        .then(function (t) {
          (t.map(function (t) {
            ...
            Y.detectingConflicts &&
              ...
              B(function () {
                $.setAttributeNode(
                  document.createAttribute(Y.detectionIgnoreAttr),
                );
                var t = (function (t, e) {
                  var n = document.createElement("script");
                  return (
